var asoiaf = function() {
    ...
    exports.getRandomCharacter = function(){
        random_id = getRandomInt(1, 2100);
        random_id = random_id.toString();
        var url = 'http://www.anapioficeandfire.com/api/characters/' + random_id;
        return httpGet(url);
    }

    exports.getRandomHouse = function(){
        random_id = getRandomInt(1, 44);
        random_id = random_id.toString();
        var url = 'http://www.anapioficeandfire.com/api/houses/' + random_id;
        return httpGet(url);
    }

    exports.getRandomCharacterOfHouse = function(house_name){
        var url = 'http://www.anapioficeandfire.com/api/houses/?name=' + house_name;
        data = httpGet(url);
        numberOfMembers = data[0].swornMembers.length;
        randomMember = getRandomInt(0, numberOfMembers);
        charURL = data[0].swornMembers[randomMember];
        return httpGet(charURL);
    }
